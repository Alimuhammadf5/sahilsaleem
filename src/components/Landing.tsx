...
const Landing: FC = () => {
  return (
    <div className=" flex w-full max-w-screen-lg flex-col items-center justify-center py-20 px-6">
      ...
      <h1 className="-z-10 mt-5 text-center text-4xl font-black leading-tight tracking-wide opacity-90 sm:mt-4 sm:text-7xl sm:leading-tight md:text-8xl md:leading-tight">
